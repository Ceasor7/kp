      ...
      <CardHeader className="p-0">
        <div className=" relative w-full h-[280px] flex items-center justify-center bg-tertiary dark:bg-secondary/40 lg:bg-work_projects_bg_light lg:dark:bg-work_projects_bg_dark lg:bg-[110%] lg:bg-no-repeat overflow-hidden ">
          ...
          <div className=" flex gap-x-5" >
            ...
            <Link href={project.github} className="bg-secondary w-[54px] h-[54px] rounded-full flex justify-center items-center scale-0 opacity-0 group-hover:scale-100 group-hover:opacity-100 transition-all duration-200"><GitHubLogoIcon className=" text-white" /></Link>
          </div>
        </div>
      </CardHeader>
